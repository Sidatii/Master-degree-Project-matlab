...
listshocks = {'SHK_DLA_CPI_CORE','SHK_L_GDP_GAP','SHK_L_S','SHK_RS'}; % The last shock (monetary policy) is added in the video
...
% 1 percent
d.SHK_DLA_CPI_CORE.SHK_DLA_CPI_CORE(startsim) = 1;
...
x.series('',s.(listshocks{i}).DLA_CPI_CORE);
