...
p.std_SHK_DLA_CPI_CORE     = 0.6912;
p.std_SHK_D4L_CPI_CORE_TAR = 2;
...
dd.OBS_L_CPI_CORE   = d.L_CPI_CORE;
...
dd.OBS_D4L_CPI_CORE_TAR  = d.D4L_CPI_CORE_TAR;
...
x.series('',[d.DLA_CPI_CORE d.D4L_CPI_CORE_TAR]);
...
x.series('',[d.DLA_CPI_CORE d.DLA_CPI_RW], 'legendEntry=', {'domestic Core inflation','foreign inflation'});
...
x.series('',[d.DLA_CPI_CORE d.DLA_CPI_CORE-d.SHK_DLA_CPI_CORE], 'legendEntry=', {'Actual','Predicted'});

x.graph('Core Inflation and RMC, percent','legend',true);
x.series('',[d.DLA_CPI_CORE-d.D4L_CPI_CORE_TAR d.RMC],'legendEntry=', {'Core Inflation (deviation from the target)','RMC'});
...
x.series('',[d.a1*d.DLA_CPI_CORE{-1} (1-d.a1)*d.E_DLA_CPI_CORE d.a2*d.a3*d.L_GDP_GAP d.a2*(1-d.a3)*d.L_Z_GAP d.SHK_DLA_CPI_CORE],...
  'legendEntry=',{'Persistency','Expectations','Output Gap','RER Gap','Shock'},'plotfunc',@barcon);
x.series('',d.DLA_CPI_CORE,'legendEntry=',{'Inflation'});
